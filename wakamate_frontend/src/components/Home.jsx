    ...
    <div className='bg-zinc-900'>
      <div className='flex items-center pb-20 flex-col  pt-30 text-white'>
       ...
       <motion.div
        ...
        className='text-[12em] BigFont item-center mx-auto'>WAKAMATE
        </motion.div>
        <h2 className='-mt-13 items-center text-center'>Plan routes, track sales, restock on time and boost your business all in one  smart AI,<br /> for small vendors and everyday hustlers </h2>
       <a 
          href="/register"
      ...
      <div className='px-10 pb-20 pt-45'>
        ...
        <h1 className='text-white text-5xl pt-4 w-[75%]'>
         <ScrollReveal
                baseOpacity={0}
                enableBlur={true}
                baseRotation={5}
      ...
      <div className='flex flex-col items-center gap-5 px-10 py-20'>
         <div className=' flex gap-4 '>
           <h1 className='border border-white text-2xl text-white rounded-full px-10 py-5'>Profit Tracking</h1>
            <h1 className='border border-white text-2xl text-white rounded-full px-10 py-5'>Smart Restocking</h1>
             <h1 className='border border-white text-2xl text-white rounded-full px-10 py-5'>Customer Engagement</h1>
              
         </div>
         <div className='flex gap-4'>
          <h1 className='border border-white text-2xl text-white rounded-full px-10 py-5'>Inventory Management</h1>
               <h1 className='border border-white text-2xl text-white rounded-full px-10 py-5'>Route Planning</h1>
         </div>
      </div>
