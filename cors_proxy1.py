...
AGENT_BASE_URL = "http://localhost:6000"
...
if __name__ == '__main__':
    ...
    print(f"📡 Proxying requests from http://localhost:3002/api/* to {AGENT_BASE_URL}/*")
    print(f"🔧 Test the proxy: http://localhost:3002/test")
